        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <a class="btn btn-primary" href="index.php?c=department&m=add"> Create new Class room</a>
                    <div class="row">
                        ...
                        <tbody>
                            <?php foreach($departments as $key => $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-sm" href="index.php?c=classroom&m=edit&id=<?= $item['id'];?>"> Edit</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger btn-sm" href="index.php?c=classroom&m=delete&id=<?= $item['id'];?>"> Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script type="text/javascript">
    let btnSearch = document.getElementById('btnSearchClassroom');
    btnSearch.addEventListener('click', function(){
        let keyword = document.getElementById('keywordClassroom');
        let valueKeyword = keyword.value.trim();
        if(valueKeyword != ''){
            window.location.href = "index.php?c=classroom&search=" + valueKeyword;
        } else {
